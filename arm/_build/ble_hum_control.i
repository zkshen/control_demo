...
#line 4 "..\\ble_hum_control.c"
#line 5 "..\\ble_hum_control.c"
#line 6 "..\\ble_hum_control.c"
...
{
    ((void)(p_ble_evt));
    p_hum_control->conn_handle = 0xFFFF;
}
...
static void on_write(ble_hum_control_t * p_hum_control, ble_evt_t * p_ble_evt)
{
    ...
    if ((p_evt_write->handle == p_hum_control->hum_control_char_handles.value_handle) &&
        (p_evt_write->len == 1) &&
        (p_hum_control->hum_control_write_handler != 0))
    {
...
uint32_t ble_hum_control_init(ble_hum_control_t * p_hum_control, const ble_hum_control_init_t * p_hum_control_init)
{
    ...
    err_code = sd_ble_gatts_service_add(0x01, &ble_uuid, &p_hum_control->service_handle);
    if (err_code != ((0x0) + 0))
    {
        return err_code;
    }
...
void ble_hum_control_state_send(ble_hum_control_t * p_hum_control, uint8_t state)
{
    ...
    if (p_hum_control->conn_handle != 0xFFFF)
    {
    ...
    {
        do { app_error_handler((err_code), 169, (uint8_t*) "..\\ble_hum_control.c"); } while (0);
    }
}
